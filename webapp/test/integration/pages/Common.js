sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("Order/com/OrderMaster/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("Order.com.OrderMaster.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Order/com/OrderMaster/localService/mockserver"], function (mockserver) {
